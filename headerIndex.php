    ...
    <div class="wapper">
        <header>
            <div class="header_top">
                    <div class="logo">
                        <a href="index.php"><img src="images/logoFooter-removebg-preview.png" alt=""></a>
                    </div>
                    <div class="seachbox">
                        <form action="view/seach.php" id="tim" method="POST">
                            <div class="seach">
                         ...
                         if ($conn == false) {
                            ...
                            if ($result->num_rows > 0) {
                             while($row=$result->fetch_assoc()){
                                echo '
                                    <li><a href="view/sanpham.php?id='.$row['iddanhmuc'].'">'.$row['tendanhmuc'].'</a></li>
                                ';
